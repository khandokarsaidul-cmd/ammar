...
class CustomerController extends BaseController
{
    ...
    public function getCustomerSettingsView(): View
    {
        ...
        $appRegisters = BusinessSetting::where('type', 'like', 'app_register_%')->get();
        ...
        foreach ($appRegisters as $setting) {
            $data[$setting->type] = $setting->value;
        }
    ...
    public function update(CustomerUpdateSettingsRequest $request): View|RedirectResponse
    {
        ...
        $this->businessSettingRepo->updateOrInsert(type: 'app_register_earning', value: $request->app_register_earning ?? 0);

        $this->businessSettingRepo->updateOrInsert(type: 'app_register_point', value: $request->app_register_point ?? 0);

        $this->businessSettingRepo->updateOrInsert(type: 'app_register_point_start_date', value: $request->app_register_point_start_date ?? 0);

        $this->businessSettingRepo->updateOrInsert(type: 'app_register_point_end_date', value: $request->app_register_point_end_date ?? 0);
