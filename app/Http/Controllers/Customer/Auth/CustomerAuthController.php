...
if (!str_contains($user_identity, '@')) {
    $user_identity = '+88' . $user_identity;
}

$user = $this->customerRepo->getByIdentity(filters: ['identity' => $user_identity]);

      //  $user = $this->customerRepo->getByIdentity(filters: ['identity' => '+88'.$request['user_identity']]);
