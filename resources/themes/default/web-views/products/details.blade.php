                            ...
                            <div class="details __h-100 product-cart-option-container">
                                ...
                                <form id="add-to-cart-form" class="mb-2 addToCartDynamicForm">
                                    ...
                                    <div class="__btn-grp mt-2 mb-3 d--none d--sm-block">
                                        ...
                                        <div class="product-add-and-buy-section gap-2 d--sm-flex w-100" {!! $firstVariationQuantity <= 0 ? 'style="display: none;"' : '' !!}>
                                        <button type="button" data-auth-status="{{ ($guestCheckout == 1 || Auth::guard('customer')->check()) ? 'true' : 'false' }}" data-route="{{ route('shop-cart') }}" 
                                        class="btn btn-secondary w-100 action-buy-now-this-product">
                                        <span class="string-limit">{{ translate('buy_now') }}</span>
                                       </button>
                                       </div>
                                       
                                       <div class="product-add-and-buy-section gap-2 d--sm-flex w-100 mt-3" >
                                        <button type="button" class="btn btn--primary w-100 action-add-to-cart-form" type="button" data-update-text="{{ translate('update_cart') }}" data-add-text="{{ translate('add_to_cart') }}" onclick ="addToCartData({{$product}})">
                                        <span class="string-limit">{{ translate('add_to_cart') }}</span>
                                       </button>
                                       </div>
                                       
                                       <div class="product-add-and-buy-section gap-2 d--sm-flex w-100 mt-3">
                                            <a href="https://api.whatsapp.com/send?phone=+8801975553300&text={{ request()->fullUrl()}}   I Want to Buy this" target="_blank" class="btn w-100" style="background: green; border: green 1px solid; color:white;">
                                            <i class="fa fa-whatsapp me-2" ></i>
                                                <span class="string-limit">Whats App</span>
                                            </a>
                                        </div>
                                        
                                         <div class="product-add-and-buy-section gap-2 d--sm-flex w-100 mt-3">
                                            <a href="tel:{{getWebConfig(name: 'company_phone')}}"  class="btn w-100" style="background: black; border: black 1px solid; color:white;">
                                            <i class="fa fa-phone me-2" ></i>
                                                <span class="string-limit">Call For Order</span>
                                            </a>
                                        </div>
                                        
                                        <div class="product-add-and-buy-section gap-2 d--sm-flex w-100 mt-3">
                                            <a href="https://m.me/AmmarOnlineShopBD?text=*Product URL:* {{ request()->fullUrl()}}" target="_blank"  class="btn w-100" style="background: blue; border: blue 1px solid; color:white;">
                                            <i class="fa fa-comment-o me-2" ></i>
                                                <span class="string-limit">Messenger</span>
                                            </a>
                                        </div>

                                       
                                       <div class="product-add-and-buy-section gap-2 d--sm-flex w-100 mt-3" >
                                        <button type="button" data-product-id="{{ $product['id'] }}" class="btn w-100 border d-none d-sm-block product-action-add-wishlist">
                                                    <i class="fa {{($wishlistStatus == 1?'fa-heart':'fa-heart-o')}} wishlist_icon_{{$product['id']}} web-text-primary"
                                                       aria-hidden="true"></i>
            ...
            <div class="d-flex flex-column gap-1 py-2">
                ...
                <div class="d--flex gap-3 justify-content-center product-add-and-buy-section" {!! $firstVariationQuantity <= 0 ? 'style="display: none;"' : '' !!}>
                        ...
                        <button
                            ...
                            type="button" onclick ="addToCartData({{$product}})">
                            <span class="string-limit">{{translate('add_to_cart')}}</span>
                        </button>
                         <a href="https://m.me/AmmarOnlineShopBD?text=*Product URL:* {{ request()->fullUrl()}}" target="_blank"  class="btn btn-sm" style="background: blue; border: blue 1px solid; color:white;">
                                            <i class="fa fa-comment-o me-2" ></i>
                                                <span class="string-limit">Messenger</span>
                                            </a>
        ...
        dataLayer.push({
            ...
            value: {{$product->unit_price-$product->discount}},
                items: [{
                    ...
                    item_category3: "{{$product->childcategory->childcategory_name ?? ""}}",
                    item_variant  : "",
                    item_list_name: "",  
                    item_list_id  : "",  
                    index       : 0,  
