        ...
        <form action="{{ route('admin.customer.customer-settings') }}" method="post" id="update-settings">
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="customer-wallet">
                                    <input type="checkbox" class="switcher_input toggle-switch-message"
                                        name="customer_wallet" id="customer-wallet" value="1"
                                        {{ $walletStatus == 1 ? 'checked' : '' }} data-modal-id="toggle-modal"
                                        data-toggle-id="customer-wallet" data-on-image="customer-wallet-on.png"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="customer-loyalty-point">
                                    <input type="checkbox" class="switcher_input toggle-switch-message"
                                        name="customer_loyalty_point" value="1" id="customer-loyalty-point"
                                        {{ $loyaltyPointStatus == 1 ? 'checked' : '' }} data-modal-id="toggle-modal"
                                        data-toggle-id="customer-loyalty-point" data-on-image="loyalty-on.png"
                        ...
                        <div class="col-xl-4 col-md-6">
                            ...
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="ref-earning-status">
                                    <input type="checkbox" class="switcher_input toggle-switch-message"
                                        name="ref_earning_status" value="1" id="ref-earning-status"
                                        {{ $refEarningStatus == 1 ? 'checked' : '' }} data-modal-id="toggle-modal"
                                        data-toggle-id="ref-earning-status" data-on-image="referral-earning-on.png"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="refund-to-wallet">
                                    <input type="checkbox" class="switcher_input toggle-switch-message"
                                        name="refund_to_wallet" id="refund-to-wallet" value="1"
                                        {{ $walletStatus && $walletAddRefund ? 'checked' : '' }}
                                        {{ $walletStatus == 0 ? 'disabled' : '' }} data-modal-id="toggle-modal"
                                        data-toggle-id="refund-to-wallet" data-on-image="refund-wallet-on.png"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                ...
                                <label class="switcher" for="add-funds-to-wallet">
                                    <input type="checkbox" class="switcher_input toggle-switch-message"
                                        name="add_funds_to_wallet" value="1" id="add-funds-to-wallet"
                                        {{ $walletStatus && $addFundsToWallet ? 'checked' : '' }}
                                        {{ $walletStatus == 0 ? 'disabled' : '' }} data-modal-id="toggle-modal"
                                        data-toggle-id="add-funds-to-wallet" data-on-image="wallet-on.png"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                ...
                                <input type="text" class="form-control" name="loyalty_point_exchange_rate"
                                    {{ $loyaltyPointStatus == 0 ? 'disabled' : '' }} id="loyalty_point_exchange_rate"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                ...
                                <input type="text" class="form-control" name="item_purchase_point"
                                    id="item_purchase_point" placeholder="{{ translate('ex') . ':' . '10' }}"
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                ...
                                <input type="text" class="form-control" name="minimun_transfer_point"
                                    id="minimum_transfer_point" placeholder="{{ translate('ex') . ':' . '10' }}"
                                    {{ $loyaltyPointStatus == 0 ? 'disabled' : '' }}
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                ...
                                <input type="text" class="form-control" name="ref_earning_exchange_rate"
                                    id="ref_earning_exchange_rate" placeholder="{{ translate('ex') . ':' . '10' }}"
            ...
            <div class="card mb-3">
                <div class="border-bottom px-4 py-3">
                    <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                        <i class="tio-award"></i>
                        {{ translate('App Installer And Register Earning Settings') }}
                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right"
                            title="{{ translate('Customer can get the reward point for app installer and register for one time') }}">
                            <img width="16"
                                src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                alt="">
                        </span>
                ...
                <div class="card-body">
                    <div class="row align-items-end gy-2">
                        <div class="col-xl-4 col-md-6">
                           <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                <span class="title-color" for="app_register_earning">
                                    {{ __('App Register Earning') }}
                                </span>

                                <label class="switcher" for="app_register_earning">
                                    <input type="checkbox" class="switcher_input toggle-switch-message"
                                        name="app_register_earning" id="app_register_earning" value="1"
                                        {{ $data['app_register_earning'] == 1 ? 'checked' : '' }}
                                        data-modal-id="toggle-modal" data-toggle-id="app_register_earning"
                                        data-on-image="customer-wallet-on.png" data-off-image="customer-wallet-off.png"
                                        data-on-title="{{ __('want to turn on App Register Earning?') }}"
                                        data-off-title="{{ __('want to turn off App Register Earning?') }}"
                                        data-on-message="<p>{{ __('if enabled customers can get the reward point for app installer and register') }}</p>"
                                        data-off-message="<p>{{ __('if disabled customers can not get the reward point for app installer and register') }}</p>">
                                    <span class="switcher_control"></span>
                                </label>
                            </div>
                        </div>

                        {{-- "app_register_earning" => "0"
                        "app_register_point" => "0"
                        "app_register_point_start_date" => ""
                        "app_register_point_end_date" => "" --}}

                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="app_register_point">
                                    {{ __('App Registration Point') }}
                                    ({{ getCurrencyCode(type: 'default') }})
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('this set amount will be the reward point which will get the customer for app installer and register') }}">
                                        <img width="16"
                                            src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                                </label>
                                <input type="text" class="form-control" name="app_register_point"
                                    id="app_register_point" placeholder="{{ translate('ex') . ':' . '10' }}" value="{{ Convert::default($data['app_register_point']) ?? 0 }}">
                            </div>
                        </div>

                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="app_register_point_start_date">
                                    {{ __('Registration Earning Start Date') }}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('this set start date will be the reward point which will get the customer for app installer and register') }}">
                                        <img width="16"
                                            src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}"
                                            alt="">
                                    </span>
                                </label>
                                <input type="date" class="form-control" name="app_register_point_start_date"
                                    id="app_register_point_start_date" value="{{ $data['app_register_point_start_date'] ? \Carbon\Carbon::parse($data['app_register_point_start_date'])->format('Y-m-d') : '' }}">
                            </div>
                        </div>

                        <div class="col-xl-4 col-md-6">
                            <div class="">
                                <label class="title-color" for="app_register_point_end_date">
                                    {{ __('Registration Earning End Date') }}
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('this set start date will be the reward point which will get the customer for app installer and register') }}">
                                        <img width="16"
                                ...
                                <input type="date" class="form-control" name="app_register_point_end_date"
                                    id="app_register_point_end_date" value="{{ $data['app_register_point_end_date'] ? \Carbon\Carbon::parse($data['app_register_point_end_date'])->format('Y-m-d') : '' }}">
                            </div>
                        </div>
                    </div>
                </div>
