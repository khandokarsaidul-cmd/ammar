...
<div class="first content-position" style="width:595px; margin: 0 auto;">
    <table class="fz-10">
        <tr>
            <td style="padding:0;text-align:{{$direction === "rtl" ? 'right' : 'left'}}">
                <div class="text-dark" style="text-transform:uppercase; font-size:22px;margin-bottom:3px">
                    {{ translate('Invoice')}}
                </div>
    ...
    <table class="border bs-0" style="border-radius:12px;">
        @if ($order->order_type == 'default_type')
            <tr>
                <td class="text-left" style="padding:18px 16px">
                ...
                <td ></td>
                <td class="text-right" style="padding:18px 12px">
                    
                    <div class="mb-1 fz-10">
                        <span class="font-bold">{{translate('invoice_of')}}</span> <span class="font-normal">{{' ( '.$currencyCode.' )'}}</span>
                    </div>
                    <div class="fz-17 text-primary text-right">৳ <b>{{ $orderTotalPriceSummary['totalAmount'] }}</b></div>
                </td>
            </tr>
            <tr>
            ...
            <td colspan="5" style="padding: 10px">
                <table class="customers bs-0">
                    ...
                    <tr>
                        ...
                        <th class="text-uppercase fz-12 text-dark font-weight-bold text-right">
                            {{ translate('qty')}}
                        </th>
                        <th class="text-uppercase text-dark fz-12 font-weight-bold text-right">
                            {{ translate('unit_Price')}}
                        </th>
                        <th class="text-right text-dark text-uppercase fz-12 font-weight-bold">
                            {{ translate('total')}}
                        </th>
                    </tr>
                    </thead>
                    ...
                    @foreach($order->details as $key=>$details)
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="fz-10 text-dark">৳ <b>{{ $details['price'] }}  <b></div>
                            </td>
                            <td class="text-right">
                                <div class="fz-10 text-dark">
                                  ৳ <b>  {{ $details['price'] * $details['qty'] }} </b>
                                </div>
                            </td>
                        </tr>
                            <?php
                        ...
                        <th class="calc-table">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="fz-10 text-dark text-right">৳ <b>{{ $orderTotalPriceSummary['itemPrice'] }}</b></td>
                                </tr>
                                <tr>
                                    <td class="text-left font-bold">{{ translate('product_Discount')}}</td>
                                    <td class="text-right fz-10 text-dark">
                                         -৳ <b>{{ $orderTotalPriceSummary['itemDiscount'] }} </b></td>
                                </tr>
                                <tr>
                                    <td class="text-left font-bold">{{ translate('sub_Total')}}</td>
                                    <td class="text-right fz-10 text-dark"> ৳ <b>{{  $orderTotalPriceSummary['subTotal'] }} </b></td>
                                </tr>
                                @if($order->order_type == 'default_type')
                                    <tr>
                                        <td class="text-left font-bold">{{ translate('shipping')}}</td>
                                        <td class="text-right fz-10 text-dark">৳ <b> {{$orderTotalPriceSummary['shippingTotal'] }}</b></td>
                                    </tr>
                                @endif
                                <tr>
                                    <td class="text-left font-bold">{{ translate('coupon_Discount')}}</td>
                                    <td class="text-right fz-10 text-dark">
                                        -৳ <b> {{ $orderTotalPriceSummary['couponDiscount'] }}</b></td>
                                </tr>
                                ...
                                @if ($order->order_type != 'default_type')
                                    <tr>
                                        ...
                                        <td class="text-right fz-10 text-dark">
                                            - ৳<b> {{ $orderTotalPriceSummary['extraDiscount'] }}</b></td>
                                    </tr>
                                @endif
                                <tr>
                                    <td class="border-dashed-top font-weight-bold text-left fz-14 font-bold">
                                        {{ translate('total')}}</td>
                                    <td class=" fz-14 text-dark">
                                       ৳ <b> {{ $orderTotalPriceSummary['totalAmount'] }}</b>
                                    </td>
                                </tr>
