                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(Helpers::module_permission_check('order_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/orders*')?((Request::is('admin/orders/details/*') && request()->has('vendor-order-list')) ? '' : 'active'):''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/orders/draft')?'active':''}}">
                                        <a class="nav-link " href="{{ route('admin.orders.draftorder') }}"
                                           title="Draft">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                                Draft
                                                    <span class="badge badge-soft-danger badge-pill ml-1">
                                                    {{ DB::table('carts')->whereNotNull('phone')->distinct('customer_id')->count('customer_id') }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                        ...
                        @if(Helpers::module_permission_check('product_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/category*') || Request::is('admin/sub-category*') || Request::is('admin/sub-sub-category*')) ?'active':''}}">
                             ...
                             <li class="navbar-vertical-aside-has-menu {{Request::is('admin/color*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="Colors">
                                    <i class="tio-shopping nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Colors</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/color*')?'block':'none'}}">
                                   
                                    <li class="nav-item {{ Request::is('admin/color/colorlist') ? 'active' : '' }}" title="{{ translate('list') }}">
    <a class="nav-link" href="{{ route('admin.color.colorlist') }}">
        <span class="tio-circle nav-indicator-icon"></span>
