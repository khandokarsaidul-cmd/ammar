...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order_management']], function () {
     ...
     Route::group(['prefix' => 'orders', 'as' => 'orders.', 'middleware' => ['module:order_management']], function(){
         Route::get('/draft', [OrderController::class, 'draftOrder'])->name('draftorder');
          Route::get('/draftdelete/{id}',[OrderController::class, 'draftdestroy'])->name('draftdelete');
    ...
    Route::group(['prefix' => 'brand', 'as' => 'brand.', 'middleware' => ['module:product_management']], function () {
        Route::controller(BrandController::class)->group(function () {
            ...
            //  Route::get(color, 'colorindex')->name('colorlist');
     ...
     Route::group(['prefix' => 'color', 'as' => 'color.', 'middleware' => ['module:product_management']], function(){
         Route::get('/', [BrandController::class, 'colorindex'])->name('colorlist');
         Route::get('/edit/{id}',[BrandController::class, 'destroy'])->name('delete');
         Route::post('/store',[BrandController::class, 'store'])->name('store');
         Route::post('/update',[BrandController::class, 'updatecolor'])->name('update');
