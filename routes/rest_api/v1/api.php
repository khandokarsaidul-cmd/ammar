...
// remove a
    ...
    Route::get('districts', 'GeneralController@district');
    Route::get('allarea/{id}', 'GeneralController@showThana');
    Route::get('registerpoint', 'GeneralController@registerPoint');
    Route::get('notification/{id}', 'GeneralController@updateNotification');
