...
Route::controller(WebController::class)->group(function () {
 ...
 Route::get('/facebook-feed', [WebController::class, 'generateFacebookFeed']);
...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode', 'guestCheck']], function () {
    ...
    Route::get('/get-thana/{id}','WebController@getthana');
    ...
    Route::post('phone-save', [WebController::class, 'phoneSave'])->name('phone-save');
